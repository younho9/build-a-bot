const BASE_URL =
  'https://raw.githubusercontent.com/younho9/build-a-bot/main/public/images';
...
const parts = {
  heads: [
    ...
    },
    {
      ...
      title: 'Friendly Bot',
      src: `${BASE_URL}/head-friendly.png`,
      cost: 945.0,
      type: 'heads',
      onSale: true,
    },
    {
      ...
      title: 'Shredder',
      src: `${BASE_URL}/head-shredder.png`,
      type: 'heads',
      cost: 1275.5,
    },
    {
      ...
      title: 'Small Cyclops',
      src: `${BASE_URL}/head-single-eye.png`,
      type: 'heads',
      cost: 750.0,
    },
    {
      ...
      src: `${BASE_URL}/head-surveillance.png`,
      type: 'heads',
      cost: 1255.5,
    },
  ],
  arms: [
    {
      ...
      title: 'Articulated',
      src: `${BASE_URL}/arm-articulated-claw.png`,
      type: 'arms',
      cost: 275,
    },
    {
      ...
      title: 'Two Clawed',
      src: `${BASE_URL}/arm-dual-claw.png`,
      type: 'arms',
      cost: 285,
    },
    {
    ...
    },
    {
      ...
      title: 'Propeller',
      src: `${BASE_URL}/arm-propeller.png`,
      type: 'arms',
      cost: 230,
      onSale: true,
    },
    {
      ...
      title: 'Stubby Claw',
      src: `${BASE_URL}/arm-stubby-claw.png`,
      type: 'arms',
      cost: 125,
    },
  ],
  torsos: [
    {
      ...
      src: `${BASE_URL}/torso-flexible-gauged.png`,
      type: 'torsos',
      cost: 1575,
    },
    {
  ...
  bases: [
    {
      ...
      src: `${BASE_URL}/base-double-wheel.png`,
      type: 'bases',
      cost: 895,
    },
    {
    ...
    },
    {
      ...
      src: `${BASE_URL}/base-single-wheel.png`,
      type: 'bases',
      cost: 1190.5,
    },
    {
    ...
    },
    {
      ...
      src: `${BASE_URL}/base-triple-wheel.png`,
      type: 'bases',
      cost: 700.5,
    },
  ],
...
const getParts = (success = true, timeout = 1000) =>
...
const postCart = (cart, success = true, timeout = 1000) =>
  new Promise((resolve, reject) => {
    setTimeout(() => {
      if (success) {
        resolve(cart);
...
export default { getParts, postCart };
